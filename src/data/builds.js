...
export const BUILDS = [
  {
    ...
    feats: [
      { niveau: 6, nom: 'Alerte', note: 'Clerc 4. +5 d’initiative : le setup Glacé/Mouillé prend deux tours, donc il doit commencer avant le paquet adverse.' },
  ...
  },
  {
    ...
    resume:
      'Guerrier d’abord pour brancher l’Attaque supplémentaire au niveau 5, Traque-Ténèbres ensuite pour l’Embuscade. Flèches arcaniques et Tireur d’élite tout du long.',
    ...
    feats: [
      ...
      { niveau: 12, nom: 'Alerte', note: 'Guerrier 8. +5 d’initiative qui s’ajoutent aux +3 de l’Embuscade.' },
    ],
    leveling: [
      ...
      { niveau: 3, classe: 'Guerrier Archer Arcanique 3', gains: 'Trois flèches arcaniques au choix (4 tirs par repos court) : Enchevêtrante, Éclatante, Perçante. Aucune option de foudre n’existe dans la liste.' },
      ...
      { niveau: 8, classe: 'Rôdeur Traque-Ténèbres 3', gains: 'Embuscade : +3 initiative et une attaque supplémentaire au premier tour. Elle arrive en pleine Acte II, donc sur des combats où le tour 1 compte vraiment.' },
    ...
    boucle: [
      'Avant le niveau 8 : pas d’opener Traque-Ténèbres. Le tour 1 se joue à la Fougue, dépensée dès qu’une cible peut tomber avant d’agir.',
      'À partir du niveau 8 : Embuscade + attaques au tour 1, souvent une cible morte avant que le paquet ne joue.',
      ...
      'Dès le niveau 5 : 2 attaques, 4 avec la Fougue, 5 si la Hâte du Sidekick est posée. Au niveau 11 le Tir incurvé rachète un raté en action bonus.',
    ],
    synergies: [
      ...
      'Une fois l’Embuscade en place (niveau 8), l’initiative de Lilian ouvre la fenêtre de contrôle avant que les ennemis n’agissent — avant ça, c’est l’Alerte de Sam qui joue ce rôle.',
    ...
    vigilance: [
      'L’ordre est Guerrier 5 d’abord, Rôdeur ensuite : prioriser le Traque-Ténèbres repousse l’Attaque supplémentaire au niveau 8 ou 9 et creuse un trou de dégâts sur tout le milieu de partie.',
      'Corollaire assumé : pas d’Embuscade ni de sorts de Rôdeur avant le niveau 8. L’Acte I se joue en archer Guerrier pur, ce qui est plus faible en initiative mais plus fiable en dégâts par tour.',
