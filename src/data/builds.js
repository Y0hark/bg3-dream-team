...
export const BUILDS = [
  ...
  },
  {
    ...
    stats: { FOR: 8, DEX: 14, CON: 14, INT: 8, SAG: 12, CHA: 17 },
    notesStats: 'CHA 17 à la création (15 + 2 raciaux), porté à 18 par Auntie Ethel’s Hair puis à 20 par l’unique ASI d’Occultiste 4 — la seule combinaison qui atteint un score pair au-delà de 18 sur ce loadout, le Cheveu n’existant qu’en un seul exemplaire dans le jeu. CON 14 plutôt que SAG 16 : Baptiste se bat au contact et perd son bonus de dégâts nécrotique dès que les PV temporaires de Symbiotic Entity tombent à zéro — la CON sert autant les PV que les sauvegardes de concentration. SAG 12 suffit : les sorts de Druide pris ici (Longstrider, Spike Growth, Moonbeam, Animate Dead) n’ont pas de DD à pousser, seulement des emplacements à préparer.',
    feats: [
      { niveau: 4, nom: 'Amélioration de caractéristique — CHA +2 (18 → 20)', note: 'Occultiste 4. Auntie Ethel’s Hair porte déjà le CHA à 18 : cette ASI — le seul palier de don côté Occultiste, Hexblade s’arrêtant à 6 sur ce split — le pousse à 20, seule façon de dépasser 18 avec un objet unique en un seul exemplaire dans le jeu.' },
      { niveau: 10, nom: 'Attaquant sauvage', note: 'Druide 4. Baptiste se fait rarement toucher en mêlée : protéger une concentration qu’il risque peu vaut moins qu’un dé de dégâts rerelancé sur l’arme liée. Attaquant sauvage fonctionne avec n’importe quelle arme — The Baneful et Sword of Life Stealing sont des épées courtes à une main. S’il passe un jour sur une arme lourde à deux mains, Cogneur lourd (Great Weapon Master) reprend ce palier de don à sa place.' },
    ],
    leveling: [
      ...
      { niveau: 4, classe: 'Occultiste 4', gains: 'Don : CHA +2 (18 → 20).' },
      ...
      { niveau: 10, classe: 'Druide 4', gains: 'Don : Attaquant sauvage.' },
