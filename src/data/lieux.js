...
export const LIEUX = [
  // ---------------------------------------------------------------- Acte I
  {
    ...
    acte: 1,
    resume: 'Hub de l’Acte I : marchands druides et tieffelins, quêtes à embranchements. Zevlor y porte les Hellrider’s Pride.',
  ...
  },
  {
    ...
    acte: 1,
    resume: 'Lady Esther campe au nord-est de Trielta Crags : la seule vendeuse de The Graceful Cloth.',
  ...
  },
  {
    ...
    nom: 'Ombreterre',
    acte: 1,
    resume: 'Les trois composants de Mourning Frost sont portés par trois mages drows dispersés dans la zone.',
    wiki: wiki('Underdark'),
    carte: null,
  },
  {
  ...
  },
  {
    ...
    nom: 'Tour arcanique',
    acte: 1,
    resume: 'Tabouret de Force de géant des collines à casser : il libère le Club of Hill Giant Strength.',
  ...
  },
  {
    ...
    nom: 'Grymforge',
    acte: 1,
    resume: 'Nere porte les Disintegrating Night Walkers ; le corsaire Greymon vend le Bow of the Banshee dès l’arrivée en radeau.',
    wiki: wiki('Grymforge'),
    carte: null,
  },
  {
    ...
    acte: 1,
    resume: 'Deux veines de mithral dans le Refuge abandonné : de quoi couler deux moules, l’armure et le bouclier.',
  ...
  },
  {
    ...
    acte: 3,
    resume: 'Coffre-fort de Raphaël : l’Amulet of Greater Health sur le piédestal de gauche des Archives. Combat à préparer.',
